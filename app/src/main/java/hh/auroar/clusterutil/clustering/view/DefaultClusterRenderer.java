...
package hh.auroar.clusterutil.clustering.view;
...
import hh.auroar.clusterutil.MarkerManager;
...
import hh.auroar.clusterutil.projection.Point;
import hh.auroar.clusterutil.projection.SphericalMercatorProjection;
import hh.auroar.clusterutil.ui.IconGenerator;
...
import static hh.auroar.clusterutil.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.MAX_DISTANCE_AT_ZOOM;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        hh.auroar.clusterutil.clustering.view.ClusterRenderer<T> {
    ...
    private hh.auroar.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
        hh.auroar.clusterutil.ui.SquareTextView squareTextView =
                new hh.auroar.clusterutil.ui.SquareTextView(context);
